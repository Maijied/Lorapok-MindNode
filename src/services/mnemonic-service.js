...
export const MnemonicService = {
    ...
    /**
     * Converts a mnemonic phrase into a single deterministic key string.
     * In a real production environment, this would use a full BIP-39 implementation.
     * Here, we treat the phrase as a high-entropy password.
     */
    phraseToKey(phrase) {
